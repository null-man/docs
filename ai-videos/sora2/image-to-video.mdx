---
title: "Sora-2"
description: "OpenAI Sora-2 视频生成模型 API 接口"
api: "POST https://api.ruxa.ai/api/v1/tasks/create"
---

<Info>
  `sora-2` 底层调用的是 OpenAI 的 Sora-2 视频生成模型，支持文生视频和图生视频。
</Info>
...
```json 200
{
  ...
  "message": "success",
  "data": {
    "taskId": "task_sora-2_1766304530229_cf4dafd2"
  }
}
```
</ResponseExample>
