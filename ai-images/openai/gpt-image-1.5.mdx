...
<Info>`gpt-image-1.5` 底层调用的是 OpenAI 的图像生成模型。</Info>
...
<ParamField body="input" type="object" required>
  ...
  <Expandable defaultOpen title="子属性">
    ...
    <ParamField body="input.quality" type="enum<string>" default="medium">
      生成图像的质量

      可用选项：`low`, `medium`, `high`
    </ParamField>
...
```json 200
{
  ...
  "message": "success",
  "data": {
    "taskId": "task_gpt-image-1.5_1766304530229_cf4dafd2"
  }
}
```
</ResponseExample>
