...
description: "基于 Gemini 2.5 Flash Image 的图像编辑模型 API 接口"
api: "POST https://api.ruxa.ai/api/v1/tasks/create"
---

<Info>
  `google/nano-banana-edit` 底层调用的是 Google 的 `gemini-2.5-flash-image`
  模型，支持通过自然语言描述对现有图像进行编辑和修改。
</Info>
...
>
  模型名称，固定为 `google/nano-banana-edit`
</ParamField>
